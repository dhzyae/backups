<template>
  <div class="app-container">
    ...
    <!-- 工具条 -->
    <div class="tools-div">
      <el-button type="success" icon="el-icon-plus" size="mini" :disabled="$hasBP('bnt.processType.add') === false" @click="add">添 加</el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <el-button type="text" size="mini" :disabled="$hasBP('bnt.processType.update') === false" @click="edit(scope.row.id)">修改</el-button>
          <el-button type="text" size="mini" :disabled="$hasBP('bnt.processType.remove') === false" @click="removeDataById(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
